...
APrototypesCharacter::APrototypesCharacter()
{
...
void APrototypesCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void APrototypesCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APrototypesCharacter::Move);
...
void APrototypesCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APrototypesCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APrototypesCharacter::SetHasRifle(bool bNewHasRifle)
{
